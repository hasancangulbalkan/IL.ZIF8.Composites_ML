...
tpot_data = pd.read_excel('E:/ZIF8IL/MLmodels/V11/rawdatamodels/N2_1BAR.xlsx', dtype=np.float64)
...
# Average CV score on the training set was: -3.57278112271134e-05
exported_pipeline = GradientBoostingRegressor(alpha=0.99, learning_rate=0.1, loss="huber", max_depth=10, max_features=0.5, min_samples_leaf=17, min_samples_split=13, n_estimators=100, subsample=0.9000000000000001)
...
ax.text(0.02, 0.97, '(c) 1 bar', transform=ax.transAxes, ha='left', va='top', fontsize=18)
