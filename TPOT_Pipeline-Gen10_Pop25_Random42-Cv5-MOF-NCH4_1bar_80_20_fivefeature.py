...
# Average CV score on the training set was: -0.0005130554926664492
exported_pipeline = make_pipeline(
    StackingEstimator(estimator=RidgeCV()),
    XGBRegressor(learning_rate=0.1, max_depth=4, min_child_weight=3, n_estimators=100, n_jobs=1, objective="reg:squarederror", subsample=0.45, verbosity=0)
)
